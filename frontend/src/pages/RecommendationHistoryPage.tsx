      ...
      <div className="relative z-10 max-w-4xl w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="space-y-6">
          <div className="flex justify-between items-center">
            ...
            <NavLink
              to="/dashboard"
              className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-br from-purple-500 to-pink-500 hover:from-purple-400 hover:to-pink-400 text-white font-medium rounded-lg hover:scale-105"
            >
          ...
          {!loading && !error && recommendations.length === 0 && (
            <GlassCard className="p-6 text-center">
              ...
              <NavLink
                to="/assessment"
                className="mt-4 inline-block bg-gradient-to-br from-purple-500 to-pink-500 hover:from-purple-400 hover:to-pink-400 text-white font-medium py-2 px-6 rounded-lg hover:scale-105"
              >
                Start Assessment
              </NavLink>
            </GlassCard>
                        ...
                        {Object.entries(
                          ...
                          <div key={month}>
                            ...
                            {data.skills_to_learn && data.skills_to_learn.length > 0 && (
                              <div className="mt-1">
                                <strong className="text-white/70 text-sm">Skills:</strong>
                                <ul className="list-disc list-inside mt-1 text-white/60 space-y-1">
